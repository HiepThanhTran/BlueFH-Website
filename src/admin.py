...
from src import app, db, services
...
class AuthenticatedAdmin(ModelView):
    ...
    def is_accessible(self):
        return (
            current_user.is_authenticated and current_user.role == AccountRoleEnum.ADMIN
        )
...
class MyAnalyticsView(BaseView):
    ...
    def index(self):
        return self.render(
            ...
            medicine_stats=services.stats_medicine_usage_per_month(
...
admin.add_view(
    MyAnalyticsView(name="Analytics", url="/admin/analytics", endpoint="analytics")
)
